...
router.post('/update', async (ctx, next) => {
	...
	//根据用户id值更新数据
	let a = await query(
		`update user set uname = '${uname}',name = '${name}',pass = '${pass}',sex ='${sex}',xueyuan ='${xueyuan}',banji = '${banji}',tel = '${tel}',lynumber = '${lynumber}',sushe = '${sushe}' where id = ${id}`
	);
	console.log(a);
